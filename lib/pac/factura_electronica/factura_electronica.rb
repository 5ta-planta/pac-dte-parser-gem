...
class Pac::FacturaElectronica::FacturaElectronica
    ...
    def cargar_firma_electronica
        @firma_electronica = new Pac::FacturaElectronica::FirmaElectronica.new(@xml_hash["rFE"]["Signature"]) # @xml_hash["rFE"]["Signature"]
    end
    ...
    def cargar_datos_generales
        ...
        @tipo_transaccion_venta = @xml_hash["rFE"]["gDGen"]["iTipoTranVenta"].to_i if @xml_hash["rFE"]["gDGen"]["iTipoTranVenta"].present?
